...
- 对正式牌堆实际包含的38种卡牌建立生产适配器，覆盖使用时机、次数、目标、距离、响应、无懈链、装备、判定、延时锦囊、伤害及处理区生命周期（六种基本牌、【无中生有】／【无懈可击】、【过河拆桥】／【顺手牵羊】、【决斗】／【火攻】、【南蛮入侵】／【万箭齐发】／【桃园结义】与【五谷丰登】已接入，【铁索连环】已接入完整语义（含属性伤害传导），其余21种仍未实现）；
